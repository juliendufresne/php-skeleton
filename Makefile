...
phpunit:
	@echo "\n\033[33m    SYMFONY_PHPUNIT_VERSION=6.5 php vendor/bin/simple-phpunit\033[39m\n"
	@                    SYMFONY_PHPUNIT_VERSION=6.5 php vendor/bin/simple-phpunit

phpunit-coverage:
	@echo "\n\033[33m    SYMFONY_PHPUNIT_VERSION=6.5 php -dzend_extension=xdebug.so vendor/bin/simple-phpunit --coverage-html reports/coverage --coverage-clover reports/clover.xml\033[39m\n"
	@                    SYMFONY_PHPUNIT_VERSION=6.5 php -dzend_extension=xdebug.so vendor/bin/simple-phpunit --coverage-html reports/coverage --coverage-clover reports/clover.xml
###< tests commands ###
